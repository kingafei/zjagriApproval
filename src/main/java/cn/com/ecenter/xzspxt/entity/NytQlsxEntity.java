...
private Integer materialInfoId;
	 ...
	 * 收费项目id
	 */
private Integer chargeitemInfoId;
	/**
	 * 常见问题解答ID
	 */
private Integer qaInfoId;
	/**
	 * 自由裁量id
	 */
private Integer factInfoid;
	/**
	 * 受理地点信息id
	 */
private Integer acceptAddressInfoId;
	/**
	 * 
	 */
...
private  String bjtype1;
	...
	public Integer getInFlowInfoId() {
		return inFlowInfoId;
	}

	public void setInFlowInfoId(Integer inFlowInfoId) {
		this.inFlowInfoId = inFlowInfoId;
	}
	...
	public Integer getChargeitemInfoId() {
		return chargeitemInfoId;
	}

	public void setChargeitemInfoId(Integer chargeitemInfoId) {
		this.chargeitemInfoId = chargeitemInfoId;
	}

	public Integer getQaInfoId() {
		return qaInfoId;
	}

	public void setQaInfoId(Integer qaInfoId) {
		this.qaInfoId = qaInfoId;
	}

	public Integer getFactInfoid() {
		return factInfoid;
	}

	public void setFactInfoid(Integer factInfoid) {
		this.factInfoid = factInfoid;
	}

	public Integer getAcceptAddressInfoId() {
		return acceptAddressInfoId;
	}

	public void setAcceptAddressInfoId(Integer acceptAddressInfoId) {
		this.acceptAddressInfoId = acceptAddressInfoId;
	}
